...
export class IssuesMouseControl extends IssuesControl {
    ...
    activate() {
        ...
        const IssuesPlugin = this.IssuesPlugin;
        const scene = this.scene;
        const cameraControl = IssuesPlugin.viewer.cameraControl;
        ...
        this._onCameraControlHoverSnapOrSurface = cameraControl.on(
            this._snapping
                ...
                if (this._currentDistanceMeasurement) {
                    ...
                    this._currentDistanceMeasurement.axisVisible = this._currentDistanceMeasurementInitState.axisVisible && this.IssuesPlugin.defaultAxisVisible;
                    this._currentDistanceMeasurement.xAxisVisible = this._currentDistanceMeasurementInitState.xAxisVisible && this.IssuesPlugin.defaultXAxisVisible;
                    this._currentDistanceMeasurement.yAxisVisible = this._currentDistanceMeasurementInitState.yAxisVisible && this.IssuesPlugin.defaultYAxisVisible;
                    this._currentDistanceMeasurement.zAxisVisible = this._currentDistanceMeasurementInitState.zAxisVisible && this.IssuesPlugin.defaultZAxisVisible;
        ...
        canvas.addEventListener("mouseup", this._onMouseUp = (e) => {
            ...
            if (this._currentDistanceMeasurement) {
                ...
                if (mouseHovering) {
                    this._currentDistanceMeasurement = IssuesPlugin.createMeasurement({
                        id: math.createUUID(),
                        origin: {
                    ...
                    this._currentDistanceMeasurementInitState.axisVisible = this._currentDistanceMeasurement.axisVisible && this.IssuesPlugin.defaultAxisVisible;
                    this._currentDistanceMeasurementInitState.xAxisVisible = this._currentDistanceMeasurement.xAxisVisible && this.IssuesPlugin.defaultXAxisVisible;
                    this._currentDistanceMeasurementInitState.yAxisVisible = this._currentDistanceMeasurement.yAxisVisible && this.IssuesPlugin.defaultYAxisVisible;
                    this._currentDistanceMeasurementInitState.zAxisVisible = this._currentDistanceMeasurement.zAxisVisible && this.IssuesPlugin.defaultZAxisVisible;
